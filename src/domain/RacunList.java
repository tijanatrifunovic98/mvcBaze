...
public class RacunList {
    ...
    public RacunList(long brojRacuna, double ukupanIznos, Date datumPrometaDobaraIUsluga, String nacinPlacanja, Date datumIzdavanja, int rokPlacanja, String mestoIzdavanja, String mestoIsporuke, String magacin, long PIB) {
