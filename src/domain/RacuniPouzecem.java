...
public class RacuniPouzecem {
    ...
    public RacuniPouzecem() {
    }

    public RacuniPouzecem(long brojRacuna, double ukupanIznos, Date datumPrometaDobaraIUsluga, String nacinPlacanja, Date datumIzdavanja, int rokPlacanja, String mestoIzdavanja, String mestoIsporuke, String magacin, long PIB) {
