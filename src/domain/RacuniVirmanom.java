...
public class RacuniVirmanom {
    ...
    public RacuniVirmanom() {
    }

    public RacuniVirmanom(long brojRacuna, double ukupanIznos, Date datumPrometaDobaraIUsluga, String nacinPlacanja, Date datumIzdavanja, int rokPlacanja, String mestoIzdavanja, String mestoIsporuke, String magacin, long PIB) {
